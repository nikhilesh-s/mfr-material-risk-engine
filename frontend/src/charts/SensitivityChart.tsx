      ...
      <div className="mt-4 h-80">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={values}>
            ...
            <XAxis dataKey="x" tick={{ fill: '#762123', fontSize: 12 }} />
            <YAxis dataKey="y" tick={{ fill: '#762123', fontSize: 12 }} />
            <Tooltip />
            <Legend />
            <Line type="monotone" dataKey="y" stroke="#9E2A2A" strokeWidth={2.5} dot={false} />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </div>
